                    ...
                    <div class="row gy-4">
                        <div class="col-12 col-md-3 mb-3">
                            <div class=" text-center text-md-start text-lg-start">
                                ...
                                <div class="d-flex gap-2  justify-content-center justify-content-sm-center justify-content-md-start">
                                    <a href="#" class="footericon"><img src="{{asset('images/twitter (1) 1.svg')}}" alt="Twitter" class="img-fluid" /></a>
                                    <a href="#" class="footericon"><img src="{{asset('images/footerfacebook.svg')}}" alt="Facebook" class="img-fluid" /></a>
                                    <a href="#" class="footericon"><img src="{{asset('images/linkedin (1) 1.svg')}}" alt="LinkedIn" class="img-fluid" /></a>
                                    <a href="#" class="footericon"><img src="{{asset('images/instagram.svg')}}" alt="Instagram" class="img-fluid" /></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-9 ">
                            <div class="row gy-4">
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    ...
                                    <h5 class="fw-semibold fs-5 text-center text-md-start text-lg-start">Useful Links</h5>
                                    <div class='d-flex justify-content-center justify-content-sm-center justify-content-md-start'>
                                        <ul class="list-unstyled mt-3">
                                            <li class="d-flex align-items-center">
                                                     <img src="{{asset('images/Vector (1).png')}}" alt="" class="me-2" />
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <h5 class="fw-semibold fs-5 text-center text-md-start text-lg-start">Services</h5>
                                    <div class='d-flex justify-content-center justify-content-sm-center justify-content-md-start'>
