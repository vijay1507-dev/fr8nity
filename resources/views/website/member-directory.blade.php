    ...
    <div class="row">
      ...
      <div>
        ...
        <div class="input-group-text p-0 w-100">
          ...
          <input type="text" class="form-control border-0" placeholder="Company name" aria-label="Company name">
        </div>
        <div class="input-group-text p-0 w-100">
          ...
          <input type="text" class="form-control border-0" placeholder="Country" aria-label="Country">
        </div>
        <div class="input-group-text p-0 w-100">
          <span class="icons d-flex"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
            fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
          ...
          <input type="text" class="form-control border-0" placeholder="City" aria-label="City">
        </div>
        <div class="input-group-text p-0 border-0 w-100">

          <input type="text" class="form-control border-0" placeholder="Specialization" aria-label="">
        </div>
        <button class="btn btn-outline-secondary search_btn" type="button">Filter</button>
        </div>
        <p class="text-white mt-3">Can't find right member? <a href="https://fr8nity.sistagging.com/contact-us"
  ...
  <div class="filter_list pb-5">
    ...
    <div class="gradient_rounded radies_20 mb-3">
      ...
      <div class="d-flex align-items-center mb-2">
        ...
        alt="Vantage Logistics Corp Logo" class="me-2 company_logo">
        <div>
        <h5 class="mb-0 text-white"> Vantage Logistics Corporation</h5>
        <span class="text-white d-block"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
          fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
          <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6" />
      ...
      <div class="d-flex align-items-center mb-2">
        ...
        <a href="{{route('members.directory-view-profile')}}" class="btn ms-auto btn btnbg fe-semibold">Get
        Contacts</a>
      </div>
