          ...
          <div class="table-responsive p-0 m-0 blacklight  ">
            <table class="table table-borderless mb-0 bg-transparent w-100">
              <thead class="blackdark">
                ...
                <th class="bg-transparent text-white">Pts</th>
                <th class="bg-transparent text-white">Founder</th>
              </thead>
              <tbody>
                <tr class="bg-transparent px-2">
                 ...
                 <tr class="bg-transparent px-2">
                  <td class="bg-transparent text-white">Monthly Transaction Value >USD1000 & <=USD5000</td>
                  <td class="bg-transparent text-white">700</td>
                  <td class="bg-transparent text-white">x2</td>
                </tr>
                 <tr class="bg-transparent px-2">
                  <td class="bg-transparent text-white">Monthly Transaction Value >USD5000 & <=USD25000</td>
                  <td class="bg-transparent text-white">1000</td>
                  <td class="bg-transparent text-white">x2</td>
                </tr>
                 <tr class="bg-transparent px-2">
                  <td class="bg-transparent text-white">Monthly Transaction Value >USD25000 & <=USD100K</td>
                  <td class="bg-transparent text-white">1500</td>
                  <td class="bg-transparent text-white">x2.5</td>
                </tr>
                 <tr class="bg-transparent px-2">
                  <td class="bg-transparent text-white">Monthly Transaction Value  Above USD100K</td>
          ...
          <div class="table-responsive p-0 m-0 blacklight  ">
            <table class="table table-borderless mb-0 bg-transparent w-100">
              ...
              <tbody>
                ...
                <tr class="bg-transparent px-2">
                  <td class="bg-transparent text-white p-2">Free online course webinar
                  </td>
