      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 mb-4 d-flex justify-content-center flex-column text-center text-md-start">
          <div>
            ...
            <p class="bannerp">The Pinnacle of Freight Partnership</p>
            <p class="bannerp">The Summit Membership is reserved for forwarders who lead with excellence and trade with vision. </p>
            <p class="bannerp">
Positioned just below the exclusive Founder tier, Summit members enjoy maximum protection, elite visibility, and priority access across FR8NITY’s trusted global network.</p>
          </div>
        </div>
          ...
          <div class="gradient_rounded radies_20 m-2 flex-fill">
            <div class="p-1 py-5 h-100 blackdark radies_20 d-flex flex-column">
              ...
              <div class="px-4 d-flex flex-column align-items-center flex-grow-1 text-center">
                ...
                <p class="text-center mb-1">Appear at the top of search results and receive the highest visibility across partner and trade requests.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="gradient_rounded radies_20 m-2 flex-fill">
            <div class="p-1 py-5 h-100 blackdark radies_20 d-flex flex-column">
              <div class="px-4 d-flex flex-column  align-items-center flex-grow-1 text-center">
                ...
                <p class="text-center mb-0">Operate with unmatched confidence. Summit members receive our most comprehensive protection plan, designed for high-value transactions (claimable with self-participation).</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <g>
      <g>
        ...
        <path fill="url(#gradient)" d="M65.049,46.49v-3.342V23.541c0,0,0.008-6.385,0-6.465l-3.746-7.59l3.324-6.32c0.354-0.67,0.33-1.475-0.062-2.121 C64.174,0.397,63.471,0,62.715,0H5.301C4.11,0,3.143,0.967,3.143,2.16l0.052,80.307h10.369V16.841H7.461V4.32h51.68l-2.186,4.15 c-0.328,0.625-0.332,1.369-0.007,1.998l3.295,6.373h-42.43v65.625h7.915h6.818h14.526h2.236c3.865,4,9.273,6.5,15.264,6.5 c11.719,0,21.25-9.532,21.25-21.25C85.825,56.158,76.547,46.746,65.049,46.49z M64.575,81.966c-7.857,0-14.25-6.394-14.25-14.25 s6.393-14.25,14.25-14.25s14.25,6.394,14.25,14.25S72.432,81.966,64.575,81.966z"/>
                ...
                <p class="text-center mb-0"> Earn more, faster. Summit members accumulate RisePoints at a higher rate — perfect for unlocking premium perks and recognitions.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <g id="SVGRepo_iconCarrier">
    ...
    <path fill="none" d="M0 0h24v24H0z"/>
                ...
                <p class="text-center mb-0"> Be the first considered for joint projects, cross-border campaigns, and spotlight opportunities.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-lg-4 mb-3 d-flex">
          <div class="gradient_rounded radies_20 m-2 flex-fill">
            <div class="p-1 py-5 h-100 blackdark radies_20 d-flex flex-column">
              ...
              <svg height="70px" width="70px" class="mb-4" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="text-center mb-0"> While not a Founder, you’ll receive special invites to selected leadership sessions with the FR8NITY core and global thought leaders.</p>
              </div>
            </div>
          </div>
        </div>
         <div class="col-12 col-sm-6 col-lg-4 mb-3 d-flex">
          <div class="gradient_rounded radies_20 m-2 flex-fill">
            <div class="p-1 py-5 h-100 blackdark radies_20 d-flex flex-column">
              <div class="px-4 d-flex flex-column  align-items-center flex-grow-1 text-center">
               <svg viewBox="0 0 24 24" height="70px" width="70px" class="mb-4"  fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" style="stop-color:#b58320"/>
      <stop offset="54.81%" style="stop-color:#ffff78"/>
  ...
  <g id="SVGRepo_iconCarrier">
    ...
    <path opacity="0.5" d="M17.9691 20C17.81 17.1085 16.9247 15 11.9999 15C7.07521 15 6.18991 17.1085 6.03076 20" stroke="url(#gradient)" stroke-width="1.5" stroke-linecap="round"/>
  </g>
</svg>
