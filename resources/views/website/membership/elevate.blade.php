      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 mb-4 d-flex justify-content-center flex-column text-center text-md-start">
          <div>
            ...
            <p class="bannerp">As an Elevate Member, you’ve moved beyond the basics. This tier is designed for freight forwarders actively 
expanding their reach and building high-trust relationships. Here’s how to maximize your membership.</p>
            ...
            <div class="p-1 py-5 h-100 blackdark radies_20 d-flex flex-column">
              ...
              <div class="px-4 d-flex flex-column align-items-center flex-grow-1">
               <svg height="70px" width="70px" class="mb-4" version="1.1" id="Capa_1"
                ...
                <h6 class="textcolor fw-semibold fs-4">Higher Network Exposure </h6>
                <p class="text-center mb-1">Appear higher in partner search results and receive enhanced visibility within the FR8NITY directory.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
  <g id="SVGRepo_iconCarrier">
    <path d="M11 19H6.2C5.07989 19 4.51984 19 4.09202 18.782C3.71569 18.5903 3.40973 18.2843 3.21799 17.908C3 17.4802 3 16.9201 3 15.8V8.2C3 7.0799 3 6.51984 3.21799 6.09202C3.40973 5.71569 3.71569 5.40973 4.09202 5.21799C4.51984 5 5.0799 5 6.2 5H17.8C18.9201 5 19.4802 5 19.908 5.21799C20.2843 5.40973 20.5903 5.71569 20.782 6.09202C21 6.51984 21 7.0799 21 8.2V12M3 9H21M18 21V15M21 18.0008L15 18" stroke="url(#gradient)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"></path>
  </g>
</svg>
                <h6 class="textcolor fw-semibold fs-4">Increased Credit Protection (USD 8,000/year)</h6>
                <p class="text-center mb-0">Trade with added assurance and better safeguard your receivables with our network-backed protection (claimable with self-participation).</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-lg-4 mb-3 d-flex">
          <div class="gradient_rounded radies_20 m-2 flex-fill">
            <div class="p-1 py-5 h-100 blackdark radies_20 d-flex flex-column">
              <div class="px-4 d-flex flex-column  align-items-center flex-grow-1 text-center">
                <svg version="1.1" id="Layer_1" width="70px" height="70px" class="mb-4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" xml:space="preserve">
  <defs>
    <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" style="stop-color:#b58320"/>
      <stop offset="54.81%" style="stop-color:#ffff78"/>
  ...
  <g id="SVGRepo_iconCarrier">
    <path id="accelerated-computing_1_" fill="url(#gradient)" d="M19,29.36c-3.401,0-6.596-1.506-8.764-4.131l0.556-0.459c2.03,2.459,5.022,3.869,8.208,3.869 c5.867,0,10.64-4.772,10.64-10.64c0-5.867-4.772-10.64-10.64-10.64c-3.186,0-6.177,1.411-8.208,3.87l-0.555-0.459 c2.091-2.532,5.137-4.022,8.403-4.125V5.36H16c-0.199,0-0.36-0.161-0.36-0.36V3c0-0.199,0.161-0.36,0.36-0.36h6 c0.199,0,0.36,0.161,0.36,0.36v2c0,0.199-0.161,0.36-0.36,0.36h-2.64v1.286c6.098,0.191,11,5.211,11,11.354 C30.36,24.264,25.264,29.36,19,29.36z M16.36,4.64h5.28V3.36h-5.28V4.64z M14,23.36H4v-0.72h10V23.36z M12,18.36H2v-0.72h10V18.36z M19.179,18.312l-0.357-0.625l7-4l0.357,0.625L19.179,18.312z M14,13.36H4v-0.72h10V13.36z"/>
    <rect id="_Transparent_Rectangle" style="fill:none;" width="32" height="32"/>
  </g>
</svg>

                <h6 class="textcolor fw-semibold fs-4 text-center">RisePoints Accelerated</h6>
                <p class="text-center mb-0"> Earn RisePoints faster through referrals, event attendance, and active participation — bringing you closer to redeemable rewards.</p>
              </div>
            </div>
          </div>
        </div>
