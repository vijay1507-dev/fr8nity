        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Generate Report: Members based on Country</h4>
                </div>
                <div class="card-body col-md-8 mx-auto">
                    ...
                    <div class="alert alert-info mb-3">
                        ...
                        <strong>Note:</strong> This report will generate member data grouped by country for the selected date range.
                    </div>
                    
                    <form id="exportForm" action="{{ route('reports.members-by-country.export') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="form-text text-muted">
                                        Leave empty to export all member records
                                    </small>
                                </div>
                            </div>
                        </div>
