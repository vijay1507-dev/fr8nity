...
<main class="content px-3 py-4">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-semibold mb-0">Edit Membership Tier</h4>
                <p class="text-muted mb-0">Update tier information, benefits, and rewards</p>
            </div>
            <div>
        ...
        <div class="dashboard-card">
            ...
            <div class="card-body p-4">
                <form id="editTierForm" method="POST" action="{{ route('membership-tiers.update', $membershipTier) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                   id="name" name="name" value="{{ old('name', $membershipTier->name) }}" required>
                            @error('name')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('order') is-invalid @enderror" 
                                   id="order" name="order" value="{{ old('order', $membershipTier->order) }}" 
                                   min="1" required>
                            @error('order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('annual_fee') is-invalid @enderror" 
                                   id="annual_fee" name="annual_fee" value="{{ old('annual_fee', $membershipTier->annual_fee) }}" 
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('credit_protection') is-invalid @enderror" 
                                   id="credit_protection" name="credit_protection" value="{{ old('credit_protection', $membershipTier->credit_protection) }}" 
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="3" required>{{ old('description', $membershipTier->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-check form-switch">
                                ...
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                       value="1" {{ old('is_active', $membershipTier->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="form-check form-switch">
                                ...
                                <input class="form-check-input" type="checkbox" id="is_visible" name="is_visible"
                                       value="1" {{ old('is_visible', $membershipTier->is_visible) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" 
                                               ...
                                               {{ in_array($benefit->id, $membershipTier->benefits->pluck('id')->toArray()) ? 'checked' : '' }}>
