...
@section('title', 'Create New Membership Benefit')
...
<main class="content px-3 py-4">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-semibold mb-0">Create New Membership Benefit</h4>
                <p class="text-muted mb-0">Add a new benefit that can be assigned to membership tiers</p>
            </div>
            <div>
        ...
        <div class="dashboard-card">
            ...
            <div class="card-body p-4">
                <form id="createBenefitForm" method="POST" action="{{ route('membership-benefits.store') }}">
                    @csrf
                    ...
                    <div class="d-flex justify-content-center gap-2 mt-4 pt-4 border-top">
                        ...
                        <button type="submit" class="btn btn-primary" id="submitBtn">
                            <i class="fas fa-save me-2"></i>Create Benefit
                        </button>
                    </div>
                </form>
            </div>
...
document.getElementById('createBenefitForm').addEventListener('submit', function(e) {
    e.preventDefault();
    ...
    .catch(error => {
        showToast('Error', 'An error occurred while creating the benefit', 'error');
    })
    .finally(() => {
